 ...
 */
public class AdvisoryFeedAdapter extends RecyclerView.Adapter<AdvisoryFeedAdapter.ViewHolder> {
    private static final String TAG = "AdvisoryFeedAdapter";

    private static List<FeedItem> mDataSet;
    private static Activity mActivity;

    public AdvisoryFeedAdapter(Activity activity, List<FeedItem> dataSet) {
        mActivity = activity;
        mDataSet = dataSet;
    }
        ...
        public ViewHolder(View v) {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    fragment = new AdvisoryDetailInfoFragment();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        // Create a new view.
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.advisory_feed_item_view, viewGroup, false);
