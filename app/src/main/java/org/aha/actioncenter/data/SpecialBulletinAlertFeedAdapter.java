 ...
 */
public class SpecialBulletinAlertFeedAdapter extends RecyclerView.Adapter<SpecialBulletinAlertFeedAdapter.ViewHolder> {
    private static final String TAG = "SpecialBulletinAlertFeedAdapter";

    private static List<FeedItem> mDataSet;
    private static Activity mActivity;

    public SpecialBulletinAlertFeedAdapter(Activity activity, List<FeedItem> dataSet) {
        mActivity = activity;
        mDataSet = dataSet;
    }
        ...
        public ViewHolder(View v) {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    fragment = new SpecialBulletinDetailInfoFragment();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        // Create a new view.
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.special_bulletin_item_view, viewGroup, false);
