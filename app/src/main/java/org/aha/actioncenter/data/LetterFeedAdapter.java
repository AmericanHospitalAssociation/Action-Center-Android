 ...
 */
public class LetterFeedAdapter extends RecyclerView.Adapter<LetterFeedAdapter.ViewHolder> {
    private static final String TAG = "ActionAlertFeedAdapter";

    private static List<FeedItem> mDataSet;
    private static Activity mActivity;

    public LetterFeedAdapter(Activity activity, List<FeedItem> dataSet) {
        mActivity = activity;
        mDataSet = dataSet;
    }
        ...
        public ViewHolder(View v) {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    fragment = new LetterDetailInfoFragment();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        // Create a new view.
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.letter_feed_item_view, viewGroup, false);
