 ...
 */
public class VoterVoiceMatchesCampaignAsyncTask extends AsyncTask<Void, Void, String> {
    private static final String TAG = "VoterVoiceMatchesCampaignAsyncTask";
    private URL mUrl;
    ...
    public VoterVoiceMatchesCampaignAsyncTask(URL url, Context context, Activity activity) {
        this(url, context);
        this.activity = activity;
    }

    public VoterVoiceMatchesCampaignAsyncTask(URL url, Context context) {
    ...
    protected void onPreExecute() {
        ...
        if (!isCancelled()) {
            if (activity != null) {
                ...
                progressDialog.setMessage("Create Directory User ...");
