 ...
 */
public class ContactUsAsyncTask extends AsyncTask<Void, Void, String> {
    ...
    public ContactUsAsyncTask(URL url, Context context, Activity activity) {
        this(url, context);
        this.activity = activity;
    }

    public ContactUsAsyncTask(URL url, Context context) {
