 ...
 */
public class LegislatorInfoAsyncTask extends AsyncTask<Void, Void, String> {
    private static final String TAG = "LegislatorInfoAsyncTask";
    private URL mUrl;
    ...
    public LegislatorInfoAsyncTask(URL url, Context context, Activity activity) {
        this(url, context);
        this.activity = activity;
    }

    public LegislatorInfoAsyncTask(URL url, Context context) {
